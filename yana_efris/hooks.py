...
app_include_js = [
    ...
    "/assets/yana_efris/js/sidebar.js?v=2.1.2",
    ...
    "/assets/yana_efris/js/print_override.js?v=0.0.1",
    ...
    "/assets/yana_efris/js/cancellation_reason.js?v=0.0.1",
    "/assets/yana_efris/js/cancellation_list.js?v=0.0.1",
