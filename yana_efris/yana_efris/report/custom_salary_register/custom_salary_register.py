...
def execute(filters=None):
	...
	for ss in salary_slips:
		...
		if currency == company_currency:
			row.update(
				{	
					"custom_incentive_q12025": ss.custom_incentive_q12025,
					"custom_incentive_q22025": ss.custom_incentive_q22025,
					"custom_incentive_q32024": ss.custom_incentive_q32024,
					"custom_incentive_q42024": ss.custom_incentive_q42024,
					"custom_taxable_income": ss.custom_taxable_income,
					"custom_paye": ss.custom_paye,
					"custom_nssf_5_employees_contribution": ss.custom_nssf_5_employees_contribution,
					"custom_net_pay_to_employee": ss.custom_net_pay_to_employee,
					"custom_cost_to_company": ss.custom_cost_to_company,
...
def get_columns(earning_types, ded_types):
	...
	columns.extend(
		[	
			{
				"label": _("Incentive (Q1-2025)"),
				"fieldname": "custom_incentive_q12025",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 150,
			},
			 {
				"label": _("Incentive (Q2-2025)"),
				"fieldname": "custom_incentive_q22025",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 150,
			},
			{
				"label": _("Incentive (Q3-2024)"),
				"fieldname": "custom_incentive_q32024",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 150,
			},
			{
				"label": _("Incentive (Q4-2024)"),
				"fieldname": "custom_incentive_q42024",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 150,
			},
			...
			{
				"label": _("PAYE"),
				"fieldname": "custom_paye",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 120,
			},
			{
				"label": _("NSSF 5% (Employee's Contribution)"),
				"fieldname": "custom_nssf_5_employees_contribution",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 180,
        	},
			{
				"label": _("Net Pay to Employee"),
				"fieldname": "custom_net_pay_to_employee",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 150,
			},
			{
				"label": _("Cost to Company"),
				"fieldname": "custom_cost_to_company",
				"fieldtype": "Currency",
				"options": "currency",
				"width": 150,
			},
